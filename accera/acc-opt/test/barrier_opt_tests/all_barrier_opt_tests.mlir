...
// CHECK-NEXT: %c4096 = constant 4096 : index
...
// CHECK-NEXT: %c4096 = constant 4096 : index
// CHECK-NEXT: %0 = "gpu.thread_id"() {dimension = "x"} : () -> index
...
// CHECK-NEXT: %3 = cmpi slt, %0, %c4096 : index
// CHECK-NEXT: scf.if %3 {
// CHECK-NEXT: %5 = memref.load %arg0[%0] : memref<4096xf32>
// CHECK-NEXT: %6 = addf %5, %cst {RelaxedPrecision} : f32
...
module @barrier_if_test_1 attributes {accv.exec_runtime = "ROCM", gpu.container_module, llvm.data_layout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"}  {
  ...
  gpu.module @NestFunction_0_module attributes {accv.exec_runtime = "ROCM", gpu.binary = "HSACO"} {
    gpu.func @NestFunction_0(%arg0: memref<4096xf32>) kernel attributes {blockSize = [4096 : i32, 1 : i32, 1 : i32], gridSize = [1 : i32, 1 : i32, 1 : i32]} {
      ...
      %3 = cmpi slt, %0, %c4096 : index
      scf.if %3 {
        %5 = memref.load %arg0[%0] : memref<4096xf32>
        %6 = addf %5, %cst {RelaxedPrecision} : f32
...
// CHECK-NEXT: %4 = cmpi slt, %0, %c4096 : index
// CHECK-NEXT: scf.if %4 {
...
// CHECK-NEXT: %c256 = constant 256 : index
...
// CHECK-NEXT: %2 = muli %1, %c16 : index
// CHECK-NEXT: %3 = addi %0, %2 : index
// CHECK-NEXT: %4 = memref.alloc() : memref<16xf32, 3>
// CHECK-NEXT: %5 = memref.alloc() : memref<16xf32, 3>
// CHECK-NEXT: %6 = muli %1, %c16 : index
// CHECK-NEXT: %7 = addi %0, %6 : index
// CHECK-NEXT: %8 = memref.load %arg0[%7] : memref<4096xf32>
// CHECK-NEXT: %9 = muli %1, %c16 : index
// CHECK-NEXT: %10 = addi %0, %9 : index
// CHECK-NEXT: memref.store %8, %4[%10] : memref<16xf32, 3>
// CHECK-NEXT: %11 = muli %1, %c16 : index
// CHECK-NEXT: %12 = addi %0, %11 : index
// CHECK-NEXT: %13 = memref.load %arg1[%12] : memref<4096xf32>
// CHECK-NEXT: %14 = muli %1, %c16 : index
// CHECK-NEXT: %15 = addi %0, %14 : index
// CHECK-NEXT: memref.store %13, %5[%15] : memref<16xf32, 3>
// CHECK-NEXT: %16 = cmpi slt, %3, %c4096 : index
// CHECK-NEXT: scf.if %16 {
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %27 = muli %1, %c16 : index
// CHECK-NEXT: %28 = addi %0, %27 : index
// CHECK-NEXT: %29 = memref.load %4[%28] : memref<16xf32, 3>
// CHECK-NEXT: %30 = muli %1, %c16 : index
// CHECK-NEXT: %31 = addi %0, %30 : index
...
// CHECK-NEXT: }
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %17 = muli %1, %c16 : index
// CHECK-NEXT: %18 = addi %0, %17 : index
// CHECK-NEXT: %19 = memref.load %arg0[%18] : memref<4096xf32>
// CHECK-NEXT: %20 = muli %1, %c16 : index
// CHECK-NEXT: %21 = addi %0, %20 : index
// CHECK-NEXT: memref.store %19, %4[%21] : memref<16xf32, 3>
// CHECK-NEXT: %22 = muli %1, %c16 : index
// CHECK-NEXT: %23 = addi %0, %22 : index
// CHECK-NEXT: %24 = memref.load %arg0[%23] : memref<4096xf32>
// CHECK-NEXT: %25 = muli %1, %c16 : index
// CHECK-NEXT: %26 = addi %0, %25 : index
...
// CHECK-NEXT: %1 = "gpu.block_id"() {dimension = "x"} : () -> index
// CHECK-NEXT: %2 = memref.alloc() : memref<16xf32, 3>
// CHECK-NEXT: %3 = muli %1, %c16 : index
// CHECK-NEXT: %4 = addi %0, %3 : index
...
// CHECK-NEXT: %13 = muli %1, %c16 : index
// CHECK-NEXT: %14 = addi %0, %13 : index
// CHECK-NEXT: %15 = memref.load %2[%14] : memref<16xf32, 3>
// CHECK-NEXT: %16 = muli %1, %c16 : index
// CHECK-NEXT: %17 = addi %0, %16 : index
// CHECK-NEXT: memref.store %15, %arg0[%17] : memref<4096xf32>
// CHECK-NEXT: } {sym_name = "value_loop"}
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %8 = muli %1, %c16 : index
// CHECK-NEXT: %9 = addi %0, %8 : index
...
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %18 = muli %1, %c16 : index
// CHECK-NEXT: %19 = addi %0, %18 : index
// CHECK-NEXT: %20 = memref.load %2[%19] : memref<16xf32, 3>
// CHECK-NEXT: %21 = muli %1, %c16 : index
// CHECK-NEXT: %22 = addi %0, %21 : index
...
// CHECK-NEXT: %5 = muli %1, %c16 : index
// CHECK-NEXT: %6 = addi %0, %5 : index
...
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %23 = muli %1, %c16 : index
// CHECK-NEXT: %24 = addi %0, %23 : index
// CHECK-NEXT: %25 = memref.load %2[%24] : memref<16xf32, 3>
// CHECK-NEXT: %26 = muli %1, %c16 : index
// CHECK-NEXT: %27 = addi %0, %26 : index
// CHECK-NEXT: %28 = memref.load %3[%27] : memref<16xf32, 3>
// CHECK-NEXT: %29 = addf %25, %28 {RelaxedPrecision} : f32
// CHECK-NEXT: %30 = muli %1, %c16 : index
// CHECK-NEXT: %31 = addi %0, %30 : index
// CHECK-NEXT: memref.store %29, %arg2[%31] : memref<4096xf32>
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: } {sym_name = "value_loop"}
// CHECK-NEXT: %7 = muli %1, %c16 : index
// CHECK-NEXT: %8 = addi %0, %7 : index
...
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: } {sym_name = "value_loop"}
// CHECK-NEXT: %10 = muli %1, %c16 : index
// CHECK-NEXT: %11 = addi %0, %10 : index
  ...
  gpu.module @NestFunction_0_module attributes {accv.exec_runtime = "ROCM", gpu.binary = "HSACO"} {
    gpu.func @NestFunction_0(%arg0: memref<4096xf32>, %arg1: memref<4096xf32>, %arg2: memref<4096xf32>) kernel attributes {blockSize = [16 : i32, 1 : i32, 1 : i32], gridSize = [256 : i32, 1 : i32, 1 : i32]} {
      ...
      scf.for %arg3 = %c0 to %c32 step %c1 {
        ...
        %29 = addf %25, %28 {RelaxedPrecision} : f32
        %30 = muli %1, %c16 : index
        %31 = addi %0, %30 : index
...
// CHECK-NEXT: %29 = muli %1, %c16 : index
// CHECK-NEXT: %30 = addi %0, %29 : index
// CHECK-NEXT: %31 = memref.load %arg0[%30] : memref<4096xf32>
// CHECK-NEXT: %32 = muli %1, %c16 : index
// CHECK-NEXT: %33 = addi %0, %32 : index
// CHECK-NEXT: memref.store %31, %2[%33] : memref<16xf32, 3>
// CHECK-NEXT: %34 = muli %1, %c16 : index
// CHECK-NEXT: %35 = addi %0, %34 : index
// CHECK-NEXT: %36 = memref.load %arg1[%35] : memref<4096xf32>
// CHECK-NEXT: %37 = muli %1, %c16 : index
// CHECK-NEXT: %38 = addi %0, %37 : index
// CHECK-NEXT: memref.store %36, %2[%38] : memref<16xf32, 3>
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %39 = muli %1, %c16 : index
// CHECK-NEXT: %40 = addi %0, %39 : index
// CHECK-NEXT: %41 = memref.load %2[%40] : memref<16xf32, 3>
// CHECK-NEXT: %42 = muli %1, %c16 : index
// CHECK-NEXT: %43 = addi %0, %42 : index
// CHECK-NEXT: %44 = memref.load %3[%43] : memref<16xf32, 3>
// CHECK-NEXT: %45 = addf %41, %44 {RelaxedPrecision} : f32
// CHECK-NEXT: %46 = muli %1, %c16 : index
// CHECK-NEXT: %47 = addi %0, %46 : index
// CHECK-NEXT: memref.store %45, %arg2[%47] : memref<4096xf32>
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: } {sym_name = "value_loop"}
// CHECK-NEXT: %15 = muli %1, %c16 : index
// CHECK-NEXT: %16 = addi %0, %15 : index
...
// CHECK-NEXT: %26 = addf %22, %25 {RelaxedPrecision} : f32
// CHECK-NEXT: %27 = muli %1, %c16 : index
// CHECK-NEXT: %28 = addi %0, %27 : index
    ...
    gpu.func @NestFunction_0(%arg0: memref<4096xf32>, %arg1: memref<4096xf32>, %arg2: memref<4096xf32>) kernel attributes {blockSize = [16 : i32, 1 : i32, 1 : i32], gridSize = [256 : i32, 1 : i32, 1 : i32]} {
      ...
      scf.for %arg3 = %c0 to %c32 step %c1 {
        ...
        scf.for %arg4 = %c0 to %c32 step %c1 {
          ...
          %45 = addf %41, %44 {RelaxedPrecision} : f32
          %46 = muli %1, %c16 : index
          %47 = addi %0, %46 : index
        ...
        %26 = addf %22, %25 {RelaxedPrecision} : f32
        %27 = muli %1, %c16 : index
        %28 = addi %0, %27 : index
...
// CHECK-NEXT: %c32 = constant 32 : index
// CHECK-NEXT: %0 = "gpu.thread_id"() {dimension = "x"} : () -> index
// CHECK-NEXT: %1 = "gpu.thread_id"() {dimension = "y"} : () -> index
// CHECK-NEXT: %2 = "gpu.block_id"() {dimension = "x"} : () -> index
// CHECK-NEXT: %3 = memref.alloc() : memref<4096xf32, 3>
// CHECK-NEXT: %4 = muli %2, %c256 : index
// CHECK-NEXT: %5 = addi %0, %4 : index
// CHECK-NEXT: %6 = muli %1, %c32 : index
// CHECK-NEXT: %7 = addi %5, %6 : index
// CHECK-NEXT: %8 = memref.load %arg0[%7] : memref<4096xf32>
// CHECK-NEXT: %9 = muli %2, %c256 : index
// CHECK-NEXT: %10 = addi %0, %9 : index
// CHECK-NEXT: %11 = muli %1, %c32 : index
// CHECK-NEXT: %12 = addi %10, %11 : index
// CHECK-NEXT: memref.store %8, %3[%12] : memref<4096xf32, 3>
// CHECK-NEXT: %13 = muli %2, %c256 : index
// CHECK-NEXT: %14 = addi %0, %13 : index
// CHECK-NEXT: %15 = muli %1, %c32 : index
// CHECK-NEXT: %16 = addi %14, %15 : index
// CHECK-NEXT: %17 = memref.load %arg0[%16] : memref<4096xf32>
// CHECK-NEXT: %18 = mulf %17, %cst {RelaxedPrecision} : f32
// CHECK-NEXT: %19 = muli %2, %c256 : index
// CHECK-NEXT: %20 = addi %0, %19 : index
// CHECK-NEXT: %21 = muli %1, %c32 : index
// CHECK-NEXT: %22 = addi %20, %21 : index
// CHECK-NEXT: memref.store %18, %arg0[%22] : memref<4096xf32>
// CHECK-NEXT: %23 = muli %2, %c256 : index
// CHECK-NEXT: %24 = addi %0, %23 : index
// CHECK-NEXT: %25 = muli %1, %c32 : index
// CHECK-NEXT: %26 = addi %24, %25 : index
// CHECK-NEXT: %27 = memref.load %arg0[%26] : memref<4096xf32>
// CHECK-NEXT: %28 = muli %2, %c256 : index
// CHECK-NEXT: %29 = addi %0, %28 : index
// CHECK-NEXT: %30 = muli %1, %c32 : index
// CHECK-NEXT: %31 = addi %29, %30 : index
// CHECK-NEXT: memref.store %27, %arg0[%31] : memref<4096xf32>
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %32 = muli %2, %c256 : index
// CHECK-NEXT: %33 = addi %0, %32 : index
// CHECK-NEXT: %34 = muli %1, %c32 : index
// CHECK-NEXT: %35 = addi %33, %34 : index
// CHECK-NEXT: %36 = memref.load %3[%35] : memref<4096xf32, 3>
// CHECK-NEXT: %37 = muli %2, %c256 : index
// CHECK-NEXT: %38 = addi %0, %37 : index
// CHECK-NEXT: %39 = muli %1, %c32 : index
// CHECK-NEXT: %40 = addi %38, %39 : index
...
// CHECK-NEXT: memref.store %2, %1[%0] : memref<16xf32, 3>
// CHECK-NEXT: %3 = memref.load %arg0[%0] : memref<4096xf32>
// CHECK-NEXT: %4 = mulf %3, %cst {RelaxedPrecision} : f32
// CHECK-NEXT: memref.store %4, %arg0[%0] : memref<4096xf32>
// CHECK-NEXT: %5 = memref.load %arg0[%0] : memref<4096xf32>
// CHECK-NEXT: memref.store %5, %arg0[%0] : memref<4096xf32>
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
...
module @barrier_seq_test_1 attributes {accv.exec_runtime = "ROCM", gpu.container_module, llvm.data_layout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"}  {
  ...
  gpu.module @NestFunction_0_module attributes {accv.exec_runtime = "ROCM", gpu.binary = "HSACO"} {
    gpu.func @NestFunction_0(%arg0: memref<4096xf32>, %arg1: memref<4096xf32>) kernel attributes {blockSize = [4096 : i32, 1 : i32, 1 : i32], gridSize = [1 : i32, 1 : i32, 1 : i32]} {
      ...
      memref.store %2, %1[%0] : memref<16xf32, 3>
      %3 = memref.load %arg0[%0] : memref<4096xf32>
      %4 = mulf %3, %cst {RelaxedPrecision} : f32
      memref.store %4, %arg0[%0] : memref<4096xf32>
      %5 = memref.load %arg0[%0] : memref<4096xf32>
      memref.store %5, %arg0[%0] : memref<4096xf32>
      "accv.barrier"() {scope = "Block"} : () -> ()
...
// CHECK-NEXT: %9 = addi %0, %8 : index
// CHECK-NEXT: %10 = memref.load %arg0[%9] : memref<4096xf32>
// CHECK-NEXT: %11 = mulf %10, %cst {RelaxedPrecision} : f32
// CHECK-NEXT: %12 = muli %1, %c16 : index
// CHECK-NEXT: %13 = addi %0, %12 : index
...
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %19 = muli %1, %c16 : index
// CHECK-NEXT: %20 = addi %0, %19 : index
...
module @barrier_single_warp_test_2 attributes {accv.exec_runtime = "ROCM", gpu.container_module, llvm.data_layout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"}  {
  ...
  gpu.module @NestFunction_0_module attributes {accv.exec_runtime = "ROCM", gpu.binary = "HSACO"} {
    gpu.func @NestFunction_0(%arg0: memref<4096xf32>) kernel attributes {blockSize = [16 : i32, 1 : i32, 1 : i32], gridSize = [256 : i32, 1 : i32, 1 : i32]} {
      ...
      %9 = addi %0, %8 : index
      %10 = memref.load %arg0[%9] : memref<4096xf32>
      %11 = mulf %10, %cst {RelaxedPrecision} : f32
      %12 = muli %1, %c16 : index
      %13 = addi %0, %12 : index
...
// CHECK-NEXT: %1 = "gpu.block_id"() {dimension = "x"} : () -> index
// CHECK-NEXT: %2 = memref.alloc() : memref<4096xf32, 3>
// CHECK-NEXT: %3 = muli %1, %c32 : index
// CHECK-NEXT: %4 = addi %0, %3 : index
// CHECK-NEXT: %5 = memref.load %arg0[%4] : memref<4096xf32>
// CHECK-NEXT: %6 = muli %1, %c32 : index
// CHECK-NEXT: %7 = addi %0, %6 : index
// CHECK-NEXT: memref.store %5, %2[%7] : memref<4096xf32, 3>
// CHECK-NEXT: %8 = muli %1, %c32 : index
// CHECK-NEXT: %9 = addi %0, %8 : index
// CHECK-NEXT: %10 = memref.load %arg0[%9] : memref<4096xf32>
// CHECK-NEXT: %11 = mulf %10, %cst {RelaxedPrecision} : f32
// CHECK-NEXT: %12 = muli %1, %c32 : index
// CHECK-NEXT: %13 = addi %0, %12 : index
// CHECK-NEXT: memref.store %11, %arg0[%13] : memref<4096xf32>
// CHECK-NEXT: %14 = muli %1, %c32 : index
// CHECK-NEXT: %15 = addi %0, %14 : index
// CHECK-NEXT: %16 = memref.load %arg0[%15] : memref<4096xf32>
// CHECK-NEXT: %17 = muli %1, %c32 : index
// CHECK-NEXT: %18 = addi %0, %17 : index
// CHECK-NEXT: memref.store %16, %arg0[%18] : memref<4096xf32>
// CHECK-NEXT: "accv.barrier"() {scope = "Block"} : () -> ()
// CHECK-NEXT: %19 = muli %1, %c32 : index
// CHECK-NEXT: %20 = addi %0, %19 : index
// CHECK-NEXT: %21 = memref.load %2[%20] : memref<4096xf32, 3>
// CHECK-NEXT: %22 = muli %1, %c32 : index
// CHECK-NEXT: %23 = addi %0, %22 : index
// CHECK-NEXT: memref.store %21, %arg0[%23] : memref<4096xf32>
// CHECK-NEXT: gpu.return
// CHECK-NEXT: }
