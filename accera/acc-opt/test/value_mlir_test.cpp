...
{
    // CHECK-NEXT:    accv.func nested @external_func_decl_{{[0-9]+}}() attributes {exec_target = 0 : i64, llvm.emit_c_interface} {
    ...
    // CHECK-NEXT:    accv.func nested @internal_func_decl_{{[0-9]+}}() attributes {exec_target = 0 : i64, llvm.emit_c_interface} {
...
{
    // CHECK-NEXT:    accv.func nested @external_func_decl_{{[0-9]+}}() attributes {accv.emit_raw_pointer_api, exec_target = 0 : i64} {
    auto externDecl = DeclareFunction("external_func_decl")
                          .External(true)
                          .RawPointerAPI(true)
                          // CHECK: return
    ...
    // CHECK-NEXT:    accv.func nested @internal_func_decl_{{[0-9]+}}() attributes {accv.emit_raw_pointer_api, exec_target = 0 : i64} {
    DeclareFunction("internal_func_decl")
        .External(false)
        .RawPointerAPI(true)
        // CHECK: return
...
{
    // CHECK-NEXT:    accv.func nested @external_func_decl_{{[0-9]+}}() attributes {accv.emit_header_decl, exec_target = 0 : i64} {
    auto externDecl = DeclareFunction("external_func_decl")
                          .External(true)
                          .HeaderDecl(true)
                          // CHECK: return
    ...
    // CHECK-NEXT:    accv.func nested @internal_func_decl_{{[0-9]+}}() attributes {accv.emit_header_decl, exec_target = 0 : i64} {
    DeclareFunction("internal_func_decl")
        .External(false)
        .HeaderDecl(true)
        // CHECK: return
...
{
    // CHECK-NEXT:    accv.func nested @no_func_tags_{{[0-9]+}}() attributes {exec_target = 0 : i64} {
    auto externDecl = DeclareFunction("no_func_tags")
                          // CHECK: return
                          // CHECK-NEXT:    }
                          .Define([] {});

    // CHECK-NEXT:    accv.func nested @has_func_tags_{{[0-9]+}}() attributes {accv.function_tags = {tag_a, tag_b}, exec_target = 0 : i64} {
