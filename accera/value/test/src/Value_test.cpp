...
Scalar UniqueName_test1()
{
    ...
    accera::testing::IsEqual(UniqueName(""), "_0");
    accera::testing::IsEqual(UniqueName(""), "_1");

    accera::testing::IsEqual(UniqueName("foo"), "foo_0");
    accera::testing::IsEqual(UniqueName("foo"), "foo_1");
