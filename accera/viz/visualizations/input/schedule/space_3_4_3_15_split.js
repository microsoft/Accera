...
async function RunViz(Viz, SceneView) {
    ...
    await Viz.SaveImage("space_3_4_3_15_split");
    ...
    await Viz.SaveImage("space_3_4_3_15_split_A");
    ...
    await Viz.SaveImage("space_3_4_3_15_split_B");
    ...
    await Viz.SaveImage("space_3_4_3_15_split_C");
}
